pipeline {
    ...
    parameters {
        ...
        string(name: 'APP_PORT', defaultValue: '5001', description: 'App port for container')
    ...
    stages {
        ...
        stage ('Deploying Container') {
            steps {
                ...
                bat "docker run -d --name ${params.CONTAINER_NAME} -p 5001:${params.APP_PORT} sganesh3010/${params.DOCKER_IMAGE_NAME}:latest"
            }
        }
    }
}
